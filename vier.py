...
@login_required
def api_properties():
    """API pour r̩cup̩rer les propri̩t̩s"""
    try:
...
# Cr̩er les tables et l'utilisateur admin par d̩faut
def create_tables():
    """Cr̩er seulement la table users - autres tables sont g̩r̩es par Airflow"""
    try:
        # IMPORTANT: Ne pas toucher aux tables cr̩̩es par Airflow (coinafrique, expat_dakar_properties, loger_dakar_properties, etc)
        # Cr̩er seulement les tables que l'application g̬re directement
        ...
        for model, name in tables_to_create:
            try:
                ...
                print(f"Erreur cr̩ation table '{name}': {e}")
        ...
        if not admin_user:
            ...
            print("Identifiants par d̩faut: admin / admin123")
        
        # Cr̩er un utilisateur analyste de d̩monstration
        ...
        if not analyst_user:
            ...
            print("Utilisateur analyste cr̩̩ avec succ̬s")
            print("Identifiants: analyst / analyst123")
        
        # Cr̩er un utilisateur viewer de d̩monstration
        ...
        if not viewer_user:
            ...
            print("Utilisateur viewer cr̩̩ avec succ̬s")
