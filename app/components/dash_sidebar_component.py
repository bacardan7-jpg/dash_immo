"""
Composant Sidebar pour les dashboards Dash
...
def create_sidebar_layout(app_content):
    ...
    # Déterminer le rôle et les capacités
    is_admin = current_user.is_authenticated and current_user.is_admin()
    is_analyst = current_user.is_authenticated and current_user.is_analyst()
    ...
    if current_user.is_authenticated:
        if current_user.first_name and current_user.last_name:
            avatar_text = f"{current_user.first_name[0]}{current_user.last_name[0]}"
